         ...
         <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center px-4 py-3 transition-colors border-l-4 ${
                isActive ? 'bg-gray-800 border-blue-500 text-white' : 'border-transparent text-gray-400 hover:bg-gray-800 hover:text-gray-200'
            ...
            className={({ isActive }) => {
                 ...
                 if (context) {
                     const isContextActive = context === 'assigned_to_me';
                      return `flex items-center px-4 py-3 transition-colors border-l-4 ${
                        isContextActive ? 'bg-gray-800 border-blue-500 text-white' : 'border-transparent text-gray-400 hover:bg-gray-800 hover:text-gray-200'
                      } ${isSidebarCollapsed ? 'justify-center px-0' : ''}`;
                 }
                 ...
                 return `flex items-center px-4 py-3 transition-colors border-l-4 ${
                    activeState ? 'bg-gray-800 border-blue-500 text-white' : 'border-transparent text-gray-400 hover:bg-gray-800 hover:text-gray-200'
                  } ${isSidebarCollapsed ? 'justify-center px-0' : ''}`;
            }}
